...
<body>
    <div class="container">
        ...
        <form action="{{ route('business_order.store') }}" method="POST">
            @csrf
            <h3>Company Name</h3>
            <input type="text" name="company_name" class="form-control" placeholder="Write your company name" required>
            <h3>Company Address</h3>
            <input type="text" name="company_address" class="form-control" placeholder="Write your company name" required>
            <h3>Title</h3>
            ...
            <p>Choose your suitable date</p>
            <select name="company_date" class="form-control" required>
            ...
            <input type="text" name="company_time" class="form-control" placeholder="Write your suitable time" required>
